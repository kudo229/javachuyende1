...
<body>
  <header class="navbar">
    ...
    <nav class="navbar-center">
      <ul>
        ...
        <li class="active">Cập nhật bệnh nhân</li>
        <li>Thêm bác sĩ</li>
        <li>Quản lý bác sĩ</li>
      </ul>
    </nav>
  ...
  <section class="dashboard">
    <h2>Cập nhật thông tin bệnh nhân</h2>
    ...
    <form class="update-form" method="POST" action="/update-doctor">
      ...
      <input type="text" id="disease" name="disease" value="Tim" required>
